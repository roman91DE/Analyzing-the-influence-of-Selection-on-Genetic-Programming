...
Table 9 displays the resulting P-values from computing the MWU test in a matrix format. The results demonstrate a highly significant difference int 
...
The mean overall performance of tournament selection appears to be superior to that of $\epsilon$-Lexicase selection which could be considered contradictory evidence to the 
... interpretation...
