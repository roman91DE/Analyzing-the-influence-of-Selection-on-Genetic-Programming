...
\midrule
\endhead
X1 & Relative Compactness\tabularnewline
X2 & Surface Area\tabularnewline
X3 & Wall Area\tabularnewline
X4 & Roof Area\tabularnewline
X5 & Overall Height\tabularnewline
X6 & Orientation\tabularnewline
X7 & Glazing Area\tabularnewline
X8 & Glazing Area Distribution\tabularnewline
y1 & Heating Load\tabularnewline
y2 & Cooling Load\tabularnewline
\bottomrule
\end{longtable}
\end{frame}
...
\caption{\label{tab:unnamed-chunk-3}Function Set}
\centering
\begin{tabular}[t]{l|r}
\hline
Function & Arity\\
...
\caption{\label{tab:unnamed-chunk-4}Terminal Set}
\centering
\begin{tabular}[t]{l|l}
\hline
...
\item
  Downside: Growth/Bloat is no clear indicator of
  overfitting\footnote<.->{Silva and Vanneschi (2009), p.~8}
\end{itemize}
\end{frame}
...
\leavevmode\hypertarget{ref-bloat_overfitting_gp}{}%
...
\leavevmode\hypertarget{ref-wang_wagner_rondinelli_2019}{}%
Wang, Y., Wagner, N. and Rondinelli, J.M. (2019) `Symbolic regression in
materials science', \emph{MRS Communications}, 9(3), pp. 793--805.
